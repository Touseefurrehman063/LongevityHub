...
class WriteProductReviewsScreen extends StatefulWidget {
  const WriteProductReviewsScreen({Key? key}) : super(key: key);

  @override
  State<WriteProductReviewsScreen> createState() =>
      _WriteProductReviewsScreenState();
}

class _WriteProductReviewsScreenState extends State<WriteProductReviewsScreen> {
  double _value = 1.5;
