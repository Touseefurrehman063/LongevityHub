...
import 'package:longevity_hub/screens/health_az/live_well_videos.dart';
import 'package:shimmer/shimmer.dart';

class LiveWellHeadingDetail extends StatefulWidget {
  final String? headingname;
  final String? url;

  const LiveWellHeadingDetail({
    Key? key,
  ...
  @override
  _LiveWellHeadingDetailState createState() => _LiveWellHeadingDetailState();
}

class _LiveWellHeadingDetailState extends State<LiveWellHeadingDetail> {
  ...
  fetchData() async {
    await HealthController.i.fetchDiscDetails(widget.url!);
    setState(() {
      _isLoading = false;
    });
  }
                  ...
                  children: [
                    ...
                    GetBuilder<HealthController>(builder: (cont) {
                      return ListView.builder(
                        ...
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: cont.maindiscList.length,
                        itemBuilder: (context, index) {
                          var liveWellDetail = cont.maindiscList[index];
