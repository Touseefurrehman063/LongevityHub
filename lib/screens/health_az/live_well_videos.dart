...
class LiveWellVideosDetail extends StatefulWidget {
  final String? headingname;
  final String? url;

  const LiveWellVideosDetail({
    Key? key,
  ...
  @override
  _LiveWellVideosDetailState createState() => _LiveWellVideosDetailState();
}

class _LiveWellVideosDetailState extends State<LiveWellVideosDetail> {
  ...
  fetchData() async {
    await HealthController.i.fetchDiscVideosDetails(widget.url!);
    setState(() {
      _isLoading = false;
    });
  }
                  ...
                  children: [
                    ...
                    GetBuilder<HealthController>(builder: (cont) {
                      return ListView.builder(
                        ...
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: cont.listDiscVideo.length,
                        itemBuilder: (context, index) {
                          var liveWellDetail = cont.listDiscVideo[index];
